    ...
    export default function Sidebar() {
        ...
        return (
            <>
                ...
                <aside className="hidden lg:flex w-64 glass-card m-4 p-6 flex-col h-[calc(100vh-2rem)]">
                    <SidebarContent />
                </aside>
                ...
                <AnimatePresence>
                    {isMobileMenuOpen && (
                        <motion.aside
                            ...
                            className="lg:hidden fixed top-0 left-0 w-72 glass-card p-6 flex flex-col h-screen z-50"
                        >
                            <SidebarContent />
                        </motion.aside>
                    )}
